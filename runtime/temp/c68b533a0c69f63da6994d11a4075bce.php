<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"F:\p2\PHPTutorial\WWW\lt\public/../application/admin\view\system\base.html";i:1534819107;s:65:"F:\p2\PHPTutorial\WWW\lt\application\admin\view\common\_meta.html";i:1534755869;s:67:"F:\p2\PHPTutorial\WWW\lt\application\admin\view\common\_header.html";i:1534921577;s:65:"F:\p2\PHPTutorial\WWW\lt\application\admin\view\common\_menu.html";i:1534834653;s:67:"F:\p2\PHPTutorial\WWW\lt\application\admin\view\common\_footer.html";i:1534755934;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<nav class="nav navbar-nav">
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加资讯','<?php echo url('article/adds'); ?>')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
							<li><a href="javascript:;" onclick="picture_add('添加资讯','<?php echo url('article/adds'); ?>')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
							<li><a href="javascript:;" onclick="product_add('添加资讯','product-add.html')"><i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
							<li><a href="javascript:;" onclick="member_add('添加用户','<?php echo url('member/add'); ?>','','510')"><i class="Hui-iconfont">&#xe60d;</i> 用户</a></li>
						</ul>
					</li>
...
<script type="text/javascript" src="/lt/public/static/admin/
lib/jquery.validation/1.14.0/messages_zh.js"></script> 
